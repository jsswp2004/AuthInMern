...
// console.log(startOfTheMonth, 'startOfTheMonth')
  ...
  const visitMonthlyDay32 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay32)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay32)
  ...
  const visitMonthlyDay33 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay33)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay33)
  ...
  const visitMonthlyDay34 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay34)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay34)
  ...
  const visitMonthlyDay35 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay35)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay35)
  ...
  const visitMonthlyDay36 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay36)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay36)
  ...
  const visitMonthlyDay37 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay37)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay37)
  ...
  const visitMonthlyDay38 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay38)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay38)
  ...
  const visitMonthlyDay39 = visits.filter((el) => {
    ...
    if (searchInput === '') {
      // return el
      return el.visitDate.toString().toLowerCase().includes(monthlyDay39)
    }
    //return the item which contains the user input
    else {
      return el.visitDate.toString().toLowerCase().includes(monthlyDay39)
