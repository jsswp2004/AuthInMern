      ...
      <div className="item2About">
        {/* <div className="HomepageGreeting"> */}
          <div className="aboutPage1">
            ...
            <h5 className="aboutPageTitle2">Dedicated to revolutionizing the way
          ...
          At POEHR, we understand the importance of accurate and up-to-date medical
              ...
              providers are able to fully utilize our systems' features. We are constantly updating our
